...
const fetchAllocations = async () => {
  const snapshot = await getDocs(query(collection(db, "resource-allocations")));
        ...
        {recentAllocations.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">
              Resources will appear here once they are allocated to projects.
            </p>
          </div>
        ) : (
            ...
            <Table>
              ...
              <TableBody>
                {recentAllocations.map((allocation) => {
                  const validStart = allocation.startDate && !isNaN(new Date(allocation.startDate));
                  const validEnd = allocation.endDate && !isNaN(new Date(allocation.endDate));
                  ...
                  return (
                    <TableRow key={allocation.id}>
                      ...
                      <TableCell>
                        <Badge
                          variant="secondary"
                          className={getStatusColor(allocation.status || "active")}
                        >
